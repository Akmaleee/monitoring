              ...
              <TableBody>
                {history.length > 0 ? (
                    ...
                    <TableRow key={item.id}>
                        ...
                        <TableCell className="text-center">{new Date(item.created_at).toLocaleString()}</TableCell>
                    </TableRow>
                    ))
                ) : (
                    <TableRow>
                        <TableCell colSpan={4} className="h-24 text-center">No history data found.</TableCell>
                    </TableRow>
                )}
              </TableBody>
            </Table>
